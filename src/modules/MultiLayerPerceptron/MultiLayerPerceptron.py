        ...
        for i in range(epochs):
            ...
            for j in range(samples):
                ...
                for layer in reversed(self.layers):
                    ...
                    weightsGradients.append(layer.getWeightsGradient())
                    biasGradients.append(layer.getBiasGradient())
                
                self.cache.weightsGradientBySample.append(weightsGradients)
                self.cache.biasGradientBySample.append(biasGradients)
